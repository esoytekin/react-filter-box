...
class CustomAutoComplete extends GridDataAutoCompleteHandler {
    ...
    needValues(
        ...
        // const cursorPosition = cm.getDoc().getCursor();
        // const text = cm.getDoc().getRange({ line: 0, ch: 0 }, cursorPosition);
        if (parsedOperator == "after") {
            return [{ customType: "date" }];
        }

        return super.needValues(parsedCategory, parsedOperator, cm);
    }
}
