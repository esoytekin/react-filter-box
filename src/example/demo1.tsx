        ...
        return (
            <div className="main-container">
                <h3>
                    ...
                    <span style={{ fontSize: 12, color: "darkgray" }}>
                        (select Status will show values auto complete){" "}
                    </span>
                    <a
                        style={{ fontSize: 12, color: "#2196F3" }}
                        href="https://github.com/nhabuiduc/react-filter-box/blob/master/js-example/src/demo1.js"
                    >
                        Source
                    </a>
                </h3>
                ...
                >
                    ...
                    <Column
                        ...
                        cell={({ rowIndex }) => (
                            <Cell>{rows[rowIndex].Description}</Cell>
                        )}
                        width={200}
                    />
                    <Column
                        ...
                        cell={({ rowIndex }) => (
                            <Cell>{rows[rowIndex].Status}</Cell>
                        )}
                        width={200}
                    />
                    <Column
